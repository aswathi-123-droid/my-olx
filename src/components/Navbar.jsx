...
function Navbar() {
  ...
  const getClassName=({isActive})=>{
    return isActive?"text-[#2dd4bf] px-3 py-2 rounded-md flex items-center gap-2 font-medium transition-colors duration-200":"text-gray-600 hover:text-[#2dd4bf] px-3 py-2 rounded-md flex items-center gap-2 font-medium transition-colors duration-200"
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-2 sm:gap-6">
            ...
            {user?<NavLink to="/sell" className={getClassName}>
